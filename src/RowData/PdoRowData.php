 ...
 * Pak proběhne nastavení výchozích dat objektu pomocí magické metody __se() a všechna další měněná a zapisovaná data jsou již ukládána pomocí metody offsetSet().
...
class PdoRowData extends RowData {
     ...
     * v konstruktoru. To znamená, že po volání konstruktoru, se už pak nikdy nevolá __set(), ale offsetSet(). Magická metoda __set() je volána
